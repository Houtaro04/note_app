...
export default function NoteList() {
    ...
    return (
        <Grid container height="100%">
            <Grid item xs={4} sx={{width: '30%', maxWidth: 360, bgcolor: '#F0EBE3', height: '100%', overflowY: 'auto', padding: '10px', textAlign: 'left'}}>
                <List
                subheader={
                    <Box sx={{display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                        <Typography sx={{fontWeight: 'bold', textAlign: 'center'}}>Notes</Typography>
